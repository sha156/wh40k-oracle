...
## 技能
- **【阵营】重生协议**
- **恶意电弧**：在您的射击阶段中，当您为模型的双联特斯拉毁灭者选择目标时，为目标单位掷一 枚 D6，并为每个位于该敌方单位 3 英寸内的其他敌方单位各掷一枚 D6。如果掷骰结果为 5+， 进行掷骰的敌方单位被恶意电弧击中；在结算该模型对目标进行的所有攻击后，每个被恶意 电弧击中的敌方单位受到 D3 处致命伤。
...
## 关键词
- **阵营关键词**：Necrons
- **普通关键词**：Vehicle，Annihilation Barge，Fly，FRAME