...
id: '000000533'
name_zh: 古墓指挥艇
name_en: Catacomb Command Barge
faction: 太空死灵
type: unit
points:
  1 model: 120
...
## 技能
- **[阵营]：重生协议**
- **载波（光环）**：当己方太空死灵单位位于该模型 6 英寸内时，该单位中模型的 OC 属性提升 1。
- **先进量子盾**：当该模型被攻击时，如果攻击的 S 属性大于该模型的 T 属性，攻击的致伤掷骰结 果减 1。
...
## 关键词
- **阵营关键词**：Necrons
- **普通关键词**：Vehicle，[[core-rules/character.md|Character]]，Catacomb Command Barge，Fly，FRAME