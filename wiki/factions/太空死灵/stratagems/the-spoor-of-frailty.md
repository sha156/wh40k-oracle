...
id: '000008405003'
name_zh: 脆弱之痕
name_en: THE SPOOR OF FRAILTY
faction: 太空死灵
type: stratagem
detachment: Annihilation Legion
cp: 1
phase: Shooting or Fight phase
stratagem_type: Annihilation Legion – Battle Tactic Stratagem
tags:
- stratagem
- stratagem/太空死灵
- 太空死灵
...
1 CP、Shooting or Fight phase、[[factions/太空死灵/detachments/annihilation-legion.md|Annihilation Legion]] 分队、Battle Tactic Stratagem。
