...
20 分、[[factions/太空死灵/detachments/cursed-legion.md|诅咒军团]] 分队。
...
[[factions/太空死灵/units/catacomb-command-barge.md|Catacomb Command Barge]] or [[factions/太空死灵/units/overlord.md|Overlord]] model only.