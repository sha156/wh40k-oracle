...
## 技能
- **【阵营技能】：黑暗契约**
- **快速突袭**：如果本单位本回合进行过冲锋移动， 近战攻击时 S+1
- **混沌圣旗**：装备者所在单位可以重投为黑暗契约 技能所进行的 LD 测试
...
- **普通关键词**：Chaos Bikers，Chaos，[[core-rules/grenades.md|Grenades]]，[[core-rules/mounted.md|Mounted]]