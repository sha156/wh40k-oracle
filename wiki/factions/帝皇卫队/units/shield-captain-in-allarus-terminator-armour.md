...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| 终结者[[factions/帝皇卫队/units/shield-captain.md\|盾卫连长]] | 5" | 7 | 2+ | 7 | 6+ | 2 |
...
## 技能
- **【阵营技能】：禁军武艺**
- **金光战甲**：每场游戏一次性，任意阶段开始时，可以使用本技能，每次分配给此模型一次攻击时，该攻击的伤害属性均变为 1
- **精熟战略**：每个游戏大回合一次，全军中一个拥有此技能的模型所在的单位被使用一个战略技能时，CP 消耗减少 1 点
