...
- **残暴掠夺者**：如果您在己方指挥阶段结束时控制一枚目 标标记，并且该单位位于那个目标标记的范围内，那么就算目标标记的 范围内没有己方单位，它也依旧被您控制，直到对手在回合开始或结束时将其控制为止。
- **武器装备技能-幻象榴弹发射器**：持有者的单位获得手雷、烟幕关键词。
- **阴谋团印记**：阴谋团印记：当持有者的单位不处于战斗震慑状态时持有者的目标控制属性增加1点。
...
## 关键词
- **阵营关键词**：Drukhari
- **普通关键词**：[[core-rules/infantry.md|Infantry]]，Kabal，[[core-rules/battleline.md|Battleline]]，Aeldari，Kabalite Warriors