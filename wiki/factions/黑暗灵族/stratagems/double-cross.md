...
id: '000010589002'
name_zh: 双重背叛
name_en: DOUBLE-CROSS
faction: 黑暗灵族
type: stratagem
detachment: Kabalite Cartel
cp: 1
phase: Fight phase
stratagem_type: Kabalite Cartel – Strategic Ploy Stratagem
tags:
- stratagem
- stratagem/黑暗灵族
- 黑暗灵族
...
1 CP、Fight phase、[[factions/黑暗灵族/detachments/kabalite-cartel.md|Kabalite Cartel]] 分队、Strategic Ploy Stratagem。
...
One Kabal or Blades for Hire unit from your army that was selected as the target of one or more of the attacking unit’s attacks, and one friendly Drukhari unit (excluding Vehicles).
