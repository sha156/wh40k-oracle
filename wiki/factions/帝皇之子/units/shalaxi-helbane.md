...
## 技能
- **无处可逃**：此模型可以重投奔跑与冲锋骰。
- **狩猎之王**：在第一战斗轮次开始时，选择一个敌方单位来作为该模型的猎物。每当该模型对其猎物进行近战攻击时，您可以重掷命中掷骰和致伤掷骰。每当该模型的猎物被摧毁时，选择一个新的敌方单位来作为猎物。
- **高阶色孽恶魔（光环)**：当一个己方色孽逆理魔军单位位于该模型的 6" 内时，那个单位位于己方混沌之影中。
...
- **普通关键词**：Summoned，Daemon，Chaos，[[core-rules/psyker.md|Psyker]]，[[core-rules/character.md|Character]]，Monster，[[core-rules/epic-hero.md|Epic Hero]]，Slaanesh，Shalaxi Helbane