---
id: '000008418005'
name_en: HYPERSENSORY SCILLIA
faction: 泰伦虫族
type: stratagem
detachment: Vanguard Onslaught
cp: 2
phase: Movement phase
stratagem_type: Vanguard Onslaught – Strategic Ploy Stratagem
tags:
- stratagem
- stratagem/泰伦虫族
- 泰伦虫族
...
2 CP、Movement phase、[[factions/泰伦虫族/detachments/vanguard-onslaught.md|Vanguard Onslaught]] 分队、Strategic Ploy Stratagem。
