...
| 战犬伏尔甘巨型爆弹炮 | 48" | 20 | 3+ | 6 | -1 | 2 | [[core-rules/sustained-hits.md\|连击1]] |
...
## 技能
- **【阵营技能】：超重型机甲**
- **高耸巨像**：如对本模型使用战略能力，需支付2倍原本 该战略能力的CP值。
- **高速迂回**：本模型加速移动时不投加速骰，改为直到阶 段结束前模型M面板值+8"。
- **受损：剩余1-13W时**：当本模型剩余1-13W时，本模型的OC值-8，每次攻击时命中骰结果-1。
...
- **普通关键词**：Vehicle，[[core-rules/walker.md|Walker]]，Warhound Titan，Imperium，[[core-rules/titanic.md|Titanic]]，[[core-rules/towering.md|Towering]]，FRAME