...
- book: Faction Pack Tau Empire
  ...
  - 52
raw:
- data_refined\Faction Pack Tau Empire\page_051.md
- data_refined\Faction Pack Tau Empire\page_052.md
---

## 属性表
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| Y’vahra Battlesuit | 10" | 9 | 2+ | 15 | 7+ | 4 |
...
## 单位构成
- **单位构成**：1台 Y’vahra Battlesuit。
- **默认装备**：flechette pod; ionic discharge cannon; phased plasma-flamer; battlesuit fists。
- **装备选项**：该模型最多可以装备2个 missile drones。

## 关键词
- 阵营关键词：**T’au Empire**
- 普通关键词：**Vehicle, Walker, Fly, Battlesuit, Y’vahra**