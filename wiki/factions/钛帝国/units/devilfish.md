...
## 技能
- **阵营：为了上上善道**
- **快速部署**：单位可以在该运输工具进行突进后下车。这样做的单位在该阶段中被视为进行了常规移动，并且在该回合中不能进行冲锋，除此之外在该回合中仍能正常行动。
...
## 关键词
- **阵营关键词**：T’au Empire
- **普通关键词**：[[core-rules/transport.md|Transport]]，Devilfish，Vehicle，Fly，[[core-rules/dedicated-transport.md|Dedicated Transport]]，FRAME