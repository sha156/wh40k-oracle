...
## 技能
- **阵营：为了上上善道**
- **脉冲炸弹**：在对手的近战阶段结束时，选择一个位于该单位24寸内且对其可见的敌方单位（独行特工单位除外）。掷六枚D6：每有一个结果为4+，那么那个敌方单位便受到1处致命伤。
...
## 关键词
- **阵营关键词**：T’au Empire
- **普通关键词**：Fly，[[core-rules/aircraft.md|Aircraft]]，Vehicle，Sun Shark Bomber，FRAME