...
| 磁轨炮 | 72" | 1 | 4+ | 20 | -5 | D6+6 | [[core-rules/heavy.md\|重型]]，[[core-rules/devastating-wounds.md\|毁灭伤害]] |
| 寻觅者导弹 | 48" | 1 | 4+ | 14 | -3 | D6+1 | [[core-rules/one-shot.md\|单发]] |
| 并联脉冲卡宾 | 20" | 2 | 4+ | 5 | 0 | 1 | [[core-rules/twin-linked.md\|双联]] |
...
## 技能
- **阵营：为了上上善道**
- **装甲猎手**：当该模型对凶兽或载具进行攻击时，命中掷骰结果+1。
- **锁定阵列**：当该模型被选中进行射击时，结算那些攻击时，你可以重掷1枚命中掷骰，或者你可以重掷1枚造伤掷骰。
- **受损：剩余1-5W时**：当该模型剩余1-5W时，模型攻击的命中掷骰结果-1。
...
## 关键词
- **阵营关键词**：T’au Empire
- **普通关键词**：Hammerhead Gunship，Fly，Vehicle，FRAME