...
|---|---|---|---|---|---|---|---|
| 神圣战戟 | 近战 | 3 | 3+ | 5 | -2 | 1 | [[core-rules/sustained-hits.md\|连击1]] |
| 神圣钉头锤 | 近战 | 3 | 3+ | 4 | -1 | 2 | [[core-rules/lethal-hits.md\|致命一击]] |
| 虔诚者之矛 | 近战 | 3 | 3+ | 5 | -2 | 2 | — |

## 技能
- **【阵营技能】：信仰之举**
- **誓言卫士**：如果一名修女会角色领导该单位，那么以该单位为目标的攻击的致伤掷骰结果减少 1 点。
...
- **普通关键词**：[[core-rules/infantry.md|Infantry]]，[[core-rules/grenades.md|Grenades]]，Imperium，Celestian Sacresants，CELESTIAN