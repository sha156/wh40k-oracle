...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| 战争[[factions/兽人/units/boyz.md\|小子]] | 6" | 5 | 5+ | 4 | 7+ | 1 |
...
## 技能
- **【阵营技能】:WAAAGH!**
- **不稳定[[factions/艾达灵族/units/farseer.md|先知]]**：本模型所领导的单位中每有5个模型(小数点取小)，本模型的毛哥之眼武器就A+2，但如果本单位包含至少 10 个模型，毛哥之眼就额外获得【危险】技能
