---
id: '000000022'
name_en: Nob With Waaagh! Banner
faction: 兽人
type: unit
points:
  1 model: 70
...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| Nob With Waaagh! Banner | 6" | 5 | 4+ | 3 | 7+ | 1 |

## 射击武器
| 武器 | 射程 | A | BS | S | AP | D | 技能 |
|---|---|---|---|---|---|---|---|
| 魔改突突枪 | 18" | 4 | 5+ | 4 | 0 | 1 | [[core-rules/rapid-fire.md\|rapid fire 2]] |

## 近战武器
| 武器 | 射程 | A | WS | S | AP | D | 技能 |
|---|---|---|---|---|---|---|---|
| Waaagh! banner | 近战 | 3 | 3+ | 8 | -2 | 2 | — |
...
## 关键词
- **阵营关键词**：Orks
- **普通关键词**：[[core-rules/infantry.md|Infantry]]，[[core-rules/character.md|Character]]，Nob with Waaagh! Banner