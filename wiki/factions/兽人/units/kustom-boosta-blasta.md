...
## 技能
- **【阵营技能】:WAAAGH!**
- **铆钉弹幕**：在你的射击阶段中，在本模型射击之后，选择一个被本模型铆钉炮命中过的敌方单位，直到你的下个你的回合开始时，那个单位进行射击攻击时命中结果-1,多个本技能不累计
...
## 关键词
- **阵营关键词**：Orks
- **普通关键词**：Vehicle，[[core-rules/grenades.md|Grenades]]，Kustom Boosta-blasta，Speed Freeks