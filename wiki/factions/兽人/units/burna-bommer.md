...
## 技能
- **【阵营技能】:WAAAGH!**
- **燃烧炸弹**：在对手的近战阶段结束时，选择一个位于该单位 24" 内且对其可见的敌方模型（独行特工单位除外）。▪ 直到[[factions/兽人/stratagems/on-to-da-next.md|下一个]]己方回合结束前，己方欧克蛮人单位针对那个敌方单位进行的远程攻击拥有[无视掩体]。▪ 为那个敌方单位中的每一个模型掷一枚 D6：每有一个结果为 6，那个敌方单位便受到 1 处致命伤。
...
## 关键词
- **阵营关键词**：兽人
- **普通关键词**：[[core-rules/vehicle.md|载具]]，[[core-rules/aircraft.md|飞行器]]，[[core-rules/fly.md|飞行]]，飚速怪咖，燃烧轰炸机