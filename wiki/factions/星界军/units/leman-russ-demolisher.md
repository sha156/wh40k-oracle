...
- **破阵者**：当该单位使用破坏者加农进行攻击时，只要敌方单位的接战范围内没有该模型以外的友军单位，就可以将他选择为射击目标，并且该模型射击时不会因为处于敌方接战范围内受到命中惩罚。
...
- **普通关键词**：Leman Russ Demolisher，Squadron，Imperium，[[core-rules/smoke.md|Smoke]]，Vehicle，FRAME