...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| Regimental Attachés | 6" | 3 | 5+ | 1 | 7+ | 1 |
...
- **普通关键词**：Imperium，Regimental Attachés，[[core-rules/infantry.md|Infantry]]，[[core-rules/psyker.md|Psyker]]