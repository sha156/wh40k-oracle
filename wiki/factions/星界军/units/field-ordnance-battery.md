...
|---|---|---|---|---|---|---|---|
| 野战炮 | 48" | D6 | 5+ | 7 | -1 | 2 | [[core-rules/blast.md\|爆炸]]，[[core-rules/heavy.md\|重型]]，[[core-rules/indirect-fire.md\|曲射]] |
...
## 单位构成
- **2个模型** — 90 分
- **per bombast field gun** — 10 分

## 关键词
- **阵营关键词**：Astra Militarum
- **普通关键词**：[[core-rules/grenades.md|Grenades]]，Imperium，Regiment，Field Ordnance Battery，[[core-rules/infantry.md|Infantry]]，Artillery