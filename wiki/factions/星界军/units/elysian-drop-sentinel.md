...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| Elysian Drop Sentinel | 10" | 6 | 3+ | 6 | 7+ | 2 |
...
|---|---|---|---|---|---|---|---|
| Close combat weapon | 近战 | 2 | 4+ | 6 | 0 | 1 | — |
...
- **普通关键词**：Regiment，Squadron，[[core-rules/smoke.md|Smoke]]，Elysian Drop Sentinel，Vehicle，[[core-rules/walker.md|Walker]]，Imperium