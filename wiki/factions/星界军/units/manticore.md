...
## 技能
- **怒火弹幕**：在你的射击阶段，当该模型射击时，选择一个被暴风鹰火箭命中过一次或多次的敌军单位（巨兽和载具除外），直到下一个你的射击阶段开始时，那个被命中的敌军单位内的模型OC-1（最低到1）
...
- **普通关键词**：Artillery，Manticore，Squadron，Imperium，[[core-rules/smoke.md|Smoke]]，Vehicle，FRAME