...
## 技能
- **烧蚀装甲**：每场战斗一次，当一次攻击被分配到该模型时，你可以将这一次攻击的伤害属性变成0。
...
- **普通关键词**：[[core-rules/smoke.md|Smoke]]，Vehicle，Imperium，Rogal Dorn Battle Tank，Squadron，FRAME