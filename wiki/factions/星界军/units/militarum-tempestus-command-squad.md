...
| 热射激光手枪 | 24" | 1 | 3+ | 3 | -1 | 1 | [[core-rules/pistol.md\|手枪]] |
...
| 等离子手枪（过载） | 24" | 1 | 3+ | 8 | -3 | 2 | [[core-rules/hazardous.md\|危险]]，[[core-rules/pistol.md\|手枪]] |
...
## 技能
- **指挥之声**：可以对最多一个兵团单位下达 1 条命令
- **暴风兵指挥**：本单位包含暴风兵指挥官时，射击武器获得 【连击 1】技能
- **【装备技能】指挥节杖**：装备者所领导的单位可以被最多两个不同的命令同时影响
- **【装备技能】音阵总台**：装备者所在单位的军官下达命令的范围扩大到 24 寸
- **【装备技能】医疗包**：你的指挥阶段开始时，如果本单位低于起始数量，你可以将至多 D3 个 被摧毁的暴风兵小队模型加入装备者所在的单位
- **【装备技能】兵团旗帜**：装备者所在单位模型的 OC 值+1
...
- **普通关键词**：[[factions/星际战士/units/command-squad.md|Command Squad]]，[[core-rules/character.md|Character]]，Officer，Militarum Tempestus，[[core-rules/grenades.md|Grenades]]，[[core-rules/infantry.md|Infantry]]，Imperium