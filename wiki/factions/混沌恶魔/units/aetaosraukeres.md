...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| Aetaos'rau'keres | 12" | 10 | 6+ | 24 | 6+ | 6 |
...
- **Master of Magicks (Psychic)**：In your Shooting phase, select one of the following abilities: [IGNORES COVER]; [LETHAL HITS]; [sustainded hits D3]. Until the end of the phase, this model’s ranged weapon has that ability.
...
- **普通关键词**：[[core-rules/titanic.md|Titanic]]，Monster，[[core-rules/towering.md|Towering]]，Fly，[[core-rules/epic-hero.md|Epic Hero]]，Chaos，Daemon，Tzeentch，Aetaos'rau'keres，[[core-rules/character.md|Character]]，[[core-rules/psyker.md|Psyker]]