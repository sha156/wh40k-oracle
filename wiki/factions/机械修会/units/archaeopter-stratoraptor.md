...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| 始祖鸟层云[[factions/混沌星际战士/units/raptors.md\|猛禽]] | 20" | 9 | 3+ | 10 | 7+ | 0 |
...
## 技能
- **【阵营技能】：机神律令**
- **对地扫射**：每当本模型射击攻击时（目标为飞行单位时除外），命中结果+1
...
- **普通关键词**：Imperium，Fly，[[core-rules/aircraft.md|Aircraft]]，Vehicle，Skitarii，Archaeopter Stratoraptor