...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| Void Shield Generator | - | 12 | 3+ | 16 | 7+ | 0 |
...
- **Projected Void Shields (Aura)**：While a friendly model is wholly within 6" of this <span class="kwb">FORTIFICATION</span>, that model has a 4+ invulnerable save against ranged attacks.
...
- **普通关键词**：[[core-rules/fortification.md|Fortification]]，Void Shield Generator