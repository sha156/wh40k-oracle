...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| Vortex Missile Strongpoint | - | 13 | 2+ | 30 | 7+ | 0 |
...
- **普通关键词**：Vehicle，[[core-rules/titanic.md|Titanic]]，[[core-rules/fortification.md|Fortification]]，Wall of Martyrs，Vortex Missile Strongpoint，[[core-rules/transport.md|Transport]]