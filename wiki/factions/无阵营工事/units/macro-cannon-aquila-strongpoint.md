...
- **Tremor Quake**：In your Shooting phase, just after selecting a target for this model’s Aquila macro-cannon, the target unit and every other enemy <span class="kwb">INFANTRY</span> unit within 3" of that unit must take a Battle-shock test.
...
- **普通关键词**：[[core-rules/fortification.md|Fortification]]，[[core-rules/transport.md|Transport]]，Macro-cannon Aquila Strongpoint，Wall of Martyrs，Vehicle，[[core-rules/titanic.md|Titanic]]