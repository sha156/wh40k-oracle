...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| Wall Of Martyrs Defence Line | - | 12 | 2+ | 10 | 7+ | 0 |

## 技能
- **Defence Line**：When this <span class="kwb">FORTIFICATION</span> is set up, all parts of it must be set up within 1" of another part. While an <span class="kwb">INFANTRY</span> model has the Benefit of Cover as a result of this <span class="kwb">FORTIFICATION</span> (see in <span class="kwb">FORTIFICATION</span> section), that model has a 4+ invulnerable save.
- **Trench Line**：Friendly <span class="kwb">INFANTRY</span> models can be set up or end any type of move on top of the flat platform section of this <span class="kwb">FORTIFICATION</span>.
...
- **普通关键词**：Defence Line，[[core-rules/fortification.md|Fortification]]，Wall of Martyrs