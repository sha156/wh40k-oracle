...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| Wall Of Martyrs Defence Emplacement | - | 12 | 2+ | 10 | 7+ | 0 |

## 技能
- **Defence Line**：While an <span class="kwb">INFANTRY</span> model has the Benefit of Cover as a result of this Fortification(see below), that model has a 4+ invulnerable save.
...
- **普通关键词**：Defence Emplacement，[[core-rules/fortification.md|Fortification]]，Wall of Martyrs