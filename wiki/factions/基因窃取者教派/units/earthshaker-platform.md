...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| Earthshaker Platform | - | 8 | 3+ | 8 | 7+ | 2 |

## 射击武器
| 武器 | 射程 | A | BS | S | AP | D | 技能 |
|---|---|---|---|---|---|---|---|
| 撼地炮 | 240" | D6+3 | 4+ | 8 | -2 | 2 | [[core-rules/blast.md\|blast]]，[[core-rules/indirect-fire.md\|indirect fire]] |
...
- **普通关键词**：[[core-rules/fortification.md|Fortification]]，Imperium，Artillery，Earthshaker Platform