...
- **诱敌误导**：如果你的军队中包含一个或多个本模型，你可以在双方完成部署后将至多三个基因窃取者教团单位重新部署，如果你这么做，你可以无视战略预备队中已有的单位分数将这些单位置入战略预备队。
...
- **普通关键词**：[[core-rules/character.md|Character]]，Great Devourer，Primus，[[core-rules/infantry.md|Infantry]]