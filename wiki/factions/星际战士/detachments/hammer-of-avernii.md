...
Once per battle round, after your Oath of Moment target is destroyed, if a [[factions/星际战士/units/caanok-var.md|Caanok Var]] model from your army is on the battlefield, select one enemy unit visible to that model. That enemy unit becomes your Oath of Moment target until you select a new one.
