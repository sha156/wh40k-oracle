...
1 CP、Fight phase、[[factions/星际战士/detachments/rage-cursed-onslaught.md|怒咒猛攻]] 分队、Stratagem。
...
One ADEPTUS ASTARTES unit from your army that made a Charge move this turn.
