---
id: '000010467006'
name_en: RAPTORIAL VIGILANCE
faction: 星际战士
type: stratagem
detachment: Shadowmark Talon
cp: 1
phase: Movement phase
stratagem_type: Shadowmark Talon – Battle Tactic Stratagem
tags:
- stratagem
- stratagem/星际战士
- 星际战士
...
1 CP、Movement phase、[[factions/星际战士/detachments/shadowmark-talon.md|影标之爪]] 分队、Battle Tactic Stratagem。
...
Your unit can make a Normal move of up to D6", or up to 6" instead if it is a Phobos or [[factions/星际战士/units/scout-squad.md|Scout Squad]] unit.