...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| Mortis [[factions/星际战士/units/dreadnought.md\|Dreadnought]] | 6" | 9 | 2+ | 8 | 6+ | 3 |

## 射击武器
| 武器 | 射程 | A | BS | S | AP | D | 技能 |
|---|---|---|---|---|---|---|---|
| 突击炮 | 24" | 6 | 3+ | 6 | 0 | 1 | [[core-rules/devastating-wounds.md\|devastating wounds]] |
| Dreadnought inferno cannon | 12" | 2D6 | N/A | 6 | -1 | 1 | [[core-rules/ignores-cover.md\|ignores cover]]，[[core-rules/torrent.md\|torrent]] |
...
## 技能
- **Mortis Strike**：Each time this model makes a ranged attack that targets a unit that is not Below Half-strength, you can re-roll the Hit roll.
...
- **普通关键词**：Dreadnought，Imperium，Mortis Dreadnought，Deathwing，[[core-rules/walker.md|Walker]]，Vehicle