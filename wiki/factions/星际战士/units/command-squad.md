...
| 重力手枪 | 12" | 1 | 3+ | 4 | -1 | 2 | [[core-rules/anti.md\|针对载具2+]] |
...
| 等离子手枪（过载） | 12" | 1 | 3+ | 8 | -3 | 2 | [[core-rules/hazardous.md\|危险]]，[[core-rules/rapid-fire.md\|速射1]] |
...
| 格斗武器 | 近战 | 3 | 3+ | 4 | 0 | 1 | — |
| Champion’s blade | 近战 | 4 | 3+ | 5 | -2 | 2 | [[core-rules/precision.md\|精准]] |
| 动力拳 | 近战 | 2 | 3+ | 8 | -2 | 2 | — |
| 动力武器 | 近战 | 3 | 3+ | 5 | -2 | 1 | — |
| 雷霆锤 | 近战 | 2 | 4+ | 8 | -2 | 2 | [[core-rules/devastating-wounds.md\|毁灭伤害]] |
| 一对闪电爪 | 近战 | 4 | 3+ | 4 | -2 | 1 | [[core-rules/twin-linked.md\|双联]] |

## 技能
- **Astartes Shield**：The bearer has a 4+ invulnerable save.
- **Narthecium**：While this unit contains an <span class="kwb">APOTHECARY</span>, in your Command phase, you can return 1 destroyed model (excluding <span class="kwb">CHARACTER</span> models) to this unit.
- **Astartes Banner**：While this unit contains a Company [[factions/星际战士/units/ancient.md|Ancient]], add 1 to the Objective Control characteristic of models in this unit.
...
- **ATTACHED UNITS**：If a Character unit from your army with the Leader ability can be attached to a [[factions/星际战士/units/company-heroes.md|Company Heroes]] unit, it can also be attached to this unit.
...
- **普通关键词**：[[core-rules/grenades.md|Grenades]]，Command Squad，[[core-rules/infantry.md|Infantry]]，Imperium