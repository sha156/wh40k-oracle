...
id: '000000242'
name_zh: 复仇型兰德飞艇
name_en: Land Speeder Vengeance
faction: 星际战士
type: unit
points:
  1 model: 130
...
## 技能
- **【阵营技能】破敌重誓**
- **复仇风暴**：每回合一次，在对手的射击阶段中，当本模型6寸内另一个阿斯塔特修会单位被敌方单位消灭时，本模型可以在那个敌方单位完成攻击后，立即如同你的射击阶段一样，对其进行一轮射击攻击（如果是可选的目标）
...
- **普通关键词**：Imperium，Fly，Ravenwing，[[factions/星际战士/units/land-speeder.md|Land Speeder]] Vengeance，Vehicle，FRAME