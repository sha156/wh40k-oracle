...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| Primaris Company Champion | 6" | 4 | 3+ | 4 | 6+ | 1 |
...
|---|---|---|---|---|---|---|---|
| 精工动力武器 | 近战 | 5 | 2+ | 5 | -2 | 2 | [[core-rules/precision.md\|precision]] |
...
- **普通关键词**：Primaris Company Champion，[[core-rules/infantry.md|Infantry]]，[[core-rules/character.md|Character]]，[[core-rules/grenades.md|Grenades]]，Imperium，Tacticus