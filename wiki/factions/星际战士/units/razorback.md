...
## 技能
- **火力支援**：在你的射击阶段中，当本模型射击完成后，你可以选择被本模型命中过的一个敌方单位，本阶段中，本回合中从本模型脱离的友军模型攻击那个敌方单位时，可以重投造伤结果
- **【阵营技能】：破敌重誓**
...
- **普通关键词**：[[core-rules/transport.md|Transport]]，[[core-rules/dedicated-transport.md|Dedicated Transport]]，Imperium，Razorback，Vehicle，[[core-rules/smoke.md|Smoke]]，FRAME