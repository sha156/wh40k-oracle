...
- **攻城盾**：当本模型使用破坏者加农炮攻击时，目标可以是处于自身接战范围的敌方单位（但不能是处于其他友军单位接战范围的敌方单位），并且本模型射击处于自身接战范围的敌方单位时不因此遭受命中惩罚
- **【阵营技能】：破敌重誓**
...
- **普通关键词**：Vindicator，Imperium，[[core-rules/smoke.md|Smoke]]，Vehicle，FRAME