...
| 格斗武器 | 近战 | 2 | 3+ | 4 | 0 | 1 | — |
| 开膛剑 | 近战 | 3 | 4+ | 7 | -2 | 2 | [[core-rules/sustained-hits.md\|sustained hits 1]] |
| 动力拳 | 近战 | 3 | 3+ | 8 | -2 | 2 | — |
| 动力武器 | 近战 | 4 | 3+ | 5 | -2 | 1 | — |
| 雷霆锤 | 近战 | 3 | 4+ | 8 | -2 | 2 | [[core-rules/devastating-wounds.md\|devastating wounds]] |
| 一对闪电爪 | 近战 | 5 | 3+ | 4 | -2 | 1 | [[core-rules/twin-linked.md\|twin-linked]] |

## 技能
- **Astartes Shield**：The bearer has a 4+ invulnerable save.
- **Chainsword Doctrines**：Each time this unit is selected to fight, select one of the following abilities to apply to all Astartes chainswords equipped by models in this unit until the end of the phase: <br><ul><li>[SUSTAINED HITS 1] </li><li>[LETHAL HITS] </li><li>[LANCE]</li></ul>
- **ATTACHED UNITS**：If a Character unit from your army with the Leader ability can be attached to an [[factions/星际战士/units/assault-intercessor-squad.md|Assault Intercessor Squad]], it can also be attached to this unit.
...
- **普通关键词**：[[core-rules/infantry.md|Infantry]]，[[core-rules/grenades.md|Grenades]]，Imperium，Assault Squad