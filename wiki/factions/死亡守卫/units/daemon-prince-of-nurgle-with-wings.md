...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| [[factions/死亡守卫/units/daemon-prince-of-nurgle.md\|Daemon Prince of Nurgle]] with Wings | 12" | 11 | 2+ | 10 | 6+ | 3 |
...
|---|---|---|---|---|---|---|---|
| 狱火加农炮 | 24" | 3 | 2+ | 7 | -1 | 2 | [[core-rules/lethal-hits.md\|致命一击]] |
...
## 关键词
- **阵营关键词**：Death Guard
- **普通关键词**：Daemon Prince with Wings，Monster，Daemon，Nurgle，[[core-rules/character.md|Character]]，Chaos，Fly