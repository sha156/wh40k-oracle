...
| 星光骑枪 | 6" | 1 | 3+ | 9 | -3 | 3 | [[core-rules/assault.md\|突击]] |
...
## 技能
- **【阵营技能】：战斗专注**
- **极限机动**：当本单位中的模型进行一次常规移动、加速移动、撤退或冲锋移动时，在判定上述模型此次移动可移动的总距离时忽视所有垂直距离
...
## 关键词
- **阵营关键词**：Asuryani
- **普通关键词**：Shining Spears，[[core-rules/mounted.md|Mounted]]，Aeldari，Fly，Aspect Warriors