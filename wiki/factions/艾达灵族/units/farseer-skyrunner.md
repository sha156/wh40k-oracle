...
| 模型 | M | T | SV | W | LD | OC |
|---|---|---|---|---|---|---|
| 天行者[[factions/艾达灵族/units/farseer.md\|先知]] | 14" | 4 | 6+ | 5 | 6+ | 2 |
...
|---|---|---|---|---|---|---|---|
| 惊骇风暴 | 24" | D6 | 3+ | 6 | -2 | D3 | [[core-rules/blast.md\|爆炸]]，灵能 |
| 星镖手枪 | 12" | 1 | 3+ | 4 | -1 | 1 | [[core-rules/assault.md\|突击]]，[[core-rules/pistol.md\|手枪]] |
| 歌矛 | 12" | 1 | 3+ | 9 | 0 | 3 | [[core-rules/assault.md\|突击]]，灵能 |
...
|---|---|---|---|---|---|---|---|
| 歌矛 | 近战 | 2 | 2+ | 3 | 0 | 3 | 灵能 |
| 巫术之刃 | 近战 | 2 | 2+ | 3 | 0 | 2 | [[core-rules/anti.md\|反步兵 2+]]，灵能 |

## 技能
- **分歧命运（灵能）**：当本模型领导一个单位时，每个阶段一次，你可以将该单位中的一个模型（支援武器除外）的一个命中骰结果、一个造伤骰结果或一个伤害骰结果改为未修正的 6
- **【阵营技能】：战斗专注**
- **厄运（灵能）**：在你的移动阶结束时，选择一个位于该模型18寸内且可见的敌方单位，直到你的下个指挥阶段开始，当该敌方单位进行攻击时，该攻击的造伤骰结果减1；每个单位每回合只能被此能力选中一次
